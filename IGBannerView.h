...
@property(nonatomic) int bannerIndicatorType; // @synthesize bannerIndicatorType=_bannerIndicatorType;
...
- (void).cxx_destruct;
- (void)layoutSubviews;
- (id)initWithFrame:(struct CGRect)arg1 bannerIndicatorType:(int)arg2;
