...
@class CALayer, IGCellSwipeActionManager, IGCommentActionView, IGCommentContentView, IGCommentModel, NSString, UIButton, UINavigationController, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
...
@property(nonatomic) __weak id <IGCommentTableCellDelegate> delegate; // @synthesize delegate=_delegate;
