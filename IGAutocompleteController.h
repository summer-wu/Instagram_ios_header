...
@class IGHashtagAutocompleteDataSource, IGHashtagListLocalDataSource, IGPlainTableView, IGUserListAutocompleteDataSource, IGUserListLocalDataSource, NSArray, NSString, UIResponder<IGAutocompleteControllerTextInput>;
...
@property(nonatomic) int displayedResultsType; // @synthesize displayedResultsType=_displayedResultsType;
