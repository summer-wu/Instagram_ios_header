...
@class IGCollectionViewChangeSet, IGCollectionViewController, NSArray, NSIndexPath, NSString, UICollectionReusableView, UICollectionViewCell;
...
- (UICollectionReusableView *)collectionViewController:(IGCollectionViewController *)arg1 viewForSupplementaryViewOfKind:(NSString *)arg2 forItemAtIndexPath:(NSIndexPath *)arg3;
