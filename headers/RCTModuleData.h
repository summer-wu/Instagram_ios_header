...
@property(readonly, nonatomic) BOOL hasConstantsToExport; // @synthesize hasConstantsToExport=_hasConstantsToExport;
@property(readonly, nonatomic) BOOL requiresMainThreadSetup; // @synthesize requiresMainThreadSetup=_requiresMainThreadSetup;
