...
{
    BOOL _shouldShowPlaceholderForPivotGrid;
...
@property(nonatomic) BOOL shouldShowPlaceholderForPivotGrid; // @synthesize shouldShowPlaceholderForPivotGrid=_shouldShowPlaceholderForPivotGrid;
- (void).cxx_destruct;
