...
@property(nonatomic) float kCaptureButtonVideoSize; // @synthesize kCaptureButtonVideoSize=_kCaptureButtonVideoSize;
...
- (id)initWithFrame:(struct CGRect)arg1 useNewDesign:(BOOL)arg2;
