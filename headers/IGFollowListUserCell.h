...
@property(nonatomic) __weak id <IGFollowListUserCellDelegate> followListUserCelldelegate; // @synthesize followListUserCelldelegate=_followListUserCelldelegate;
...
- (void)layoutSubviews;
- (void)configureCellWithUser:(id)arg1 showSimilarAccountsView:(BOOL)arg2 showSocialContext:(BOOL)arg3 followActionBlock:(CDUnknownBlockType)arg4 dismissActionBlock:(CDUnknownBlockType)arg5;
