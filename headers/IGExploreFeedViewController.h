...
@class IGExploreMarqueeItem, IGExploreTTILogger, IGFeedItemPreviewingHandler, IGFeedStatusView, IGPullToRefreshViewManager, NSArray, NSMutableSet, NSString, UIActivityIndicatorView, UICollectionView, UIView;
...
@property(retain, nonatomic) IGExploreMarqueeItem *marqueeItem; // @synthesize marqueeItem=_marqueeItem;
@property(copy, nonatomic) NSArray *items; // @synthesize items=_items;
@property(nonatomic) struct UIEdgeInsets contentInsets; // @synthesize contentInsets=_contentInsets;
- (void).cxx_destruct;
- (void)updateCellVisibility:(id)arg1 indexPath:(id)arg2 imageView:(id)arg3 mediaIndex:(unsigned int)arg4;
