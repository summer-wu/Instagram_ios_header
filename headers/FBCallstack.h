...
@property(readonly, nonatomic) unsigned long timestamp; // @synthesize timestamp=_timestamp;
...
- (void)dealloc;
- (id)initWithSize:(int)arg1 callstack:(void *)arg2 threadID:(unsigned int)arg3 timestamp:(unsigned long)arg4;
