...
@class IGAutocompleteDataSourceStore, IGUserListAutocompleteNetworkDataSource, NSDictionary, NSString;
...
@property(retain, nonatomic) IGAutocompleteDataSourceStore *dataStore; // @synthesize dataStore=_dataStore;
