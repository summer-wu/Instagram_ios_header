...
@class IGAnalyticsConnectionObserver, IGAnalyticsLogFileManager, IGAnalyticsLogger, IGAnalyticsUploader, IGImmediateActiveSeconds, NSObject<OS_dispatch_queue>, NSString, NSTimer;
...
+ (void)setPeriodicUploadEnabled:(BOOL)arg1;
+ (id)sharedAnalytics;
@property(retain, nonatomic) NSTimer *uploadTimer; // @synthesize uploadTimer=_uploadTimer;
@property(nonatomic) int periodicUploadTimeInterval; // @synthesize periodicUploadTimeInterval=_periodicUploadTimeInterval;
@property(nonatomic) BOOL periodicUploadEnabled; // @synthesize periodicUploadEnabled=_periodicUploadEnabled;
