...
{
    BOOL _displaysTabsInNavigationBar;
...
@property(nonatomic) BOOL displaysTabsInNavigationBar; // @synthesize displaysTabsInNavigationBar=_displaysTabsInNavigationBar;
