...
@property(readonly, nonatomic) IGVideoPlayerTargetView *videoTargetView; // @synthesize videoTargetView=_videoTargetView;
...
@property(nonatomic) __weak id <IGFeedVideoPlayerPlaybackDelegate> playbackDelegate; // @synthesize playbackDelegate=_playbackDelegate;
...
- (void)loadKeys:(id)arg1 forObjects:(id)arg2 completion:(CDUnknownBlockType)arg3;
