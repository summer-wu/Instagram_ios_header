...
- (id)initWithImageFromLightweightCropper:(id)arg1 cropRect:(struct CGRect)arg2 mediaMetadata:(id)arg3;
- (id)initWithImageDirectToEditor:(id)arg1 cropRect:(struct CGRect)arg2 mediaMetadata:(id)arg3;
