...
@property(nonatomic) BOOL saveWhenDone; // @synthesize saveWhenDone=_saveWhenDone;
@property(nonatomic) float progress; // @synthesize progress=_progress;
@property(nonatomic) BOOL shouldUseFallbackSize; // @synthesize shouldUseFallbackSize=_shouldUseFallbackSize;
