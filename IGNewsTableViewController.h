...
@class IGActivityPreviewingHandler, IGNewsEmptyFeedView, IGPullToRefreshViewManager, IGTableViewInsetInfoView, IGViewController, NSArray, NSMutableDictionary, NSString, UIView;
...
- (id)sectionAtSectionIndex:(unsigned int)arg1;
